...
def t_corretagem_s3(dados, path_do_arquivo):
...
def load_corretagem_s3(
    path_do_arquivo, nome_base="corretagem", bucket="m7investimentos"
):

    pasta_destino = "../../BASE/1 - corretagem/processado/"
    dados = carregar_arquivo(path_do_arquivo)
    if dados is None:
        print("nao tem o arquivo")
        return True
    path = t_corretagem_s3(dados, path_do_arquivo)
